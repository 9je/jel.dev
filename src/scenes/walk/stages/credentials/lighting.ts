...
export function lights(): Placement[] {
  return [
    { kind: 'point', position: [LAB.x, LAB.h - 0.3, -25], color: 0xdff0f6, intensity: 7, distance: 10 },
    { kind: 'point', position: [LAB.x, LAB.h - 0.3, -19], color: 0xdff0f6, intensity: 7, distance: 10 },
